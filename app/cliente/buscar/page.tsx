    ...
    <main className="min-h-screen bg-black px-5 pt-8 text-white">
      <div className="mx-auto max-w-[430px]">
        ...
        <section className="mt-8 rounded-[26px] border border-[#ffc400]/25 bg-[#080808] p-6">
          <h1 className="text-[32px] font-black text-[#ffc400]">Buscar</h1>
          <p className="mt-3 text-white/60">Aqui depois vamos conectar API/mapa para localizar caminhões e rotas.</p>
        </section>
      </div>
    </main>
  )
